...
file downloaded = Intestinal-Microbiome-Western-Adults-master.zip
2] Unzip the file "Intestinal-Microbiome-Western-Adults-master.zip"  
3] set this as the working directory  
...
###We will noe read the files. you have to chose the file ("genome_koabundance.txt") in the new select window that will pop-ip after you run the script "file= choose.files(multi=F)"
...
###Further colouring based on phylum affiliation was done in Adobe Illustrator!!
